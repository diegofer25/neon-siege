export const SOUND_EFFECT_MANIFEST = [
    ...
    { key: 'enemy_spawn_healer', category: 'enemy', durationSeconds: 1.4, promptInfluence: 0.35, text: 'Healer enemy spawn cue, soft rising bio-electric pulse, no voice.' },
    ...
    { key: 'enemy_death_healer', category: 'enemy', durationSeconds: 1.7, promptInfluence: 0.35, text: 'Healer enemy death sound, dissolving restorative pulse with brittle crack, no voice.' },
    ...
    { key: 'enemy_heal', category: 'enemy', durationSeconds: 1.3, promptInfluence: 0.4, text: 'Enemy healing pulse sound, bright supportive energy bloom, no voice.' },
